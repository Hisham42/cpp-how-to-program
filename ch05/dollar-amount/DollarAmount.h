...
public:
   ...
   explicit DollarAmount(int64_t dollar, int64_t pennies) : amount{(dollar + pennies % 100)} { }
   ...
   void addInterest(int rate, int divisor) {
      ...
      DollarAmount interest2{interest, 0};

      add(interest2); // add interest to this object's amount
   }
